...
def houghMask(frame,lower,upper):
...
def drawBox(frame,left_line,right_line):
    ...
    x3,y3,x4,y4 = extendLine(x3,y3,x4,y4)
...
while 1:
    ...
    if ret:
        y_processed,y_lines = houghMask(frame,lower_y,upper_y)
        w_processed,w_lines = houghMask(frame,lower_w,upper_w)
